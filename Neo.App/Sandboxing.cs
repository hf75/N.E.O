...
{
    /// <summary>
    /// Immutable Sandbox-Konfiguration.
    /// </summary>
    public sealed record SandboxSettings
    {
        public bool AllowNetworkAccess { get; init; } = false;
        public bool AllowClipboardAccess { get; init; } = false;   // (per Job-Object kontrollierbar – hier nicht gesetzt)
        public bool AllowUserFileAccess { get; init; } = false;
        public bool AllowPrinting { get; init; } = false;          // (per Job-Object kontrollierbar – hier nicht gesetzt)
        public bool AllowWebcamAndMicrophone { get; init; } = false;
        public bool AllowSystemSettingsChanges { get; init; } = false; // (kein direkter AppContainer-Schalter)
