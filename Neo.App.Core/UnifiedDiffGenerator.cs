...
namespace Neo.App
{
    public static class UnifiedDiffGenerator
    {
        ...
        public static string CreatePatchForCurrentCode(string oldText, string newText, int contextLines = 3)
        {
            ...
            return BuildUnifiedDiff("./currentcode.cs", oldLines.Count, newLines.Count, ops, contextLines);
        }
            ...
            int contextLines)
        {
            ...
            // Map op-index -> old/new 1-based line numbers at that point (before applying op).
